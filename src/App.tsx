          ...
          <div className="flex gap-2 md:gap-3 items-center">
            ...
            {user ? (
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <button onClick={() => openChatWithUser()} className="relative p-2 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-800 rounded-full transition-colors bg-blue-50/50 dark:bg-transparent">
