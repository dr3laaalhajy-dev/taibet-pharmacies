    ...
    <div className="w-full flex flex-col min-h-[85vh] relative transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full overflow-x-hidden flex-1 relative">
        ...
        <header className="mb-16 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6 leading-tight">{lang === 'ar' ? <>اهلا بكم في <span className="text-blue-600 dark:text-blue-500">طيبة الإمام</span> الصحية</> : <>Taibet El-Imam <span className="text-blue-600 dark:text-blue-500">Health Platform</span></>}</h1>
